(function() {
  ...
  var compactTabStyle = document.createElement('style');
  compactTabStyle.textContent = '.tab-close{font-size:.95rem;padding:0 2px;min-width:18px;height:18px;display:inline-flex;align-items:center;justify-content:center}';
  head.appendChild(compactTabStyle);
